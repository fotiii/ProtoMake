  ...
  const paymentMethods = [
    {
      ...
      description: "Вы можете оплатить заказ наличными при получении товара. Принимаем оплату курьеру или в пункте выдачи.",
      icon: (
    ...
    },
    {
      ...
      description: "Мы принимаем оплату по безналичному расчету. Возможна оплата картой онлайн на сайте или в мобильном приложении.",
      icon: (
